...
class ProductEditPage extends React.Component {
  ...
  getPaymentProviders(organizationName) {
    ProviderBackend.getProviders(organizationName).then((res) => {
      if (res.status === "ok") {
        this.setState({
          providers: res.data.filter(
            (provider) => provider.category === "Payment"
          ),
        });
      } else {
  ...
  renderProduct() {
    const isCreatedByPlan =
      this.state.product.tag === "auto_created_product_for_plan";
    return (
      <Card
        size="small"
        title={
          <div>
            {this.state.mode === "add"
              ? i18next.t("product:New Product")
              : i18next.t("product:Edit Product")}
            &nbsp;&nbsp;&nbsp;&nbsp;
            <Button onClick={() => this.submitProductEdit(false)}>
              {i18next.t("general:Save")}
            </Button>
            <Button
              style={{ marginLeft: "20px" }}
              type="primary"
              onClick={() => this.submitProductEdit(true)}
            >
      ...
      >
        <Row style={{ marginTop: "10px" }}>
          ...
          <Col span={22}>
            <Select
              ...
              value={this.state.product.owner}
              onChange={(value) => {
                this.updateProductField("owner", value);
              }}
            >
        ...
        <Row style={{ marginTop: "20px" }}>
          ...
          <Col span={22}>
            <Input
              value={this.state.product.displayName}
              onChange={(e) => {
        ...
        <Row style={{ marginTop: "20px" }}>
          <Col style={{ marginTop: "5px" }} span={Setting.isMobile() ? 22 : 2}>
            {Setting.getLabel(
              i18next.t("product:Image"),
              i18next.t("product:Image - Tooltip")
            )}{" "}
            :
          </Col>
        ...
        <Row style={{ marginTop: "20px" }}>
          <Col style={{ marginTop: "5px" }} span={Setting.isMobile() ? 22 : 2}>
            {Setting.getLabel(
              i18next.t("user:Tag"),
              i18next.t("product:Tag - Tooltip")
            )}{" "}
            :
          </Col>
          <Col span={22}>
            <Input
              value={this.state.product.tag}
              disabled={isCreatedByPlan}
              onChange={(e) => {
        ...
        <Row style={{ marginTop: "20px" }}>
          <Col style={{ marginTop: "5px" }} span={Setting.isMobile() ? 22 : 2}>
            {Setting.getLabel(
              ...
              i18next.t("product:Detail - Tooltip")
            )}{" "}
            :
          </Col>
          <Col span={22}>
        ...
        <Row style={{ marginTop: "20px" }}>
          <Col style={{ marginTop: "5px" }} span={Setting.isMobile() ? 22 : 2}>
            {Setting.getLabel(
              i18next.t("product:Is recharge"),
              i18next.t("product:Is recharge - Tooltip")
            )}{" "}
            :
          </Col>
          <Col span={22}>
            <Switch
              checked={this.state.product.isRecharge}
              onChange={(value) => {
        ...
        <Row style={{ marginTop: "20px" }}>
          <Col style={{ marginTop: "5px" }} span={Setting.isMobile() ? 22 : 2}>
            {Setting.getLabel(
              i18next.t("product:Quantity"),
              i18next.t("product:Quantity - Tooltip")
            )}{" "}
            :
          </Col>
          <Col span={22}>
        ...
        <Row style={{ marginTop: "20px" }}>
          <Col style={{ marginTop: "5px" }} span={Setting.isMobile() ? 22 : 2}>
            {Setting.getLabel(
              i18next.t("product:Sold"),
              i18next.t("product:Sold - Tooltip")
            )}{" "}
            :
          </Col>
          <Col span={22}>
            <InputNumber
              value={this.state.product.sold}
              disabled={isCreatedByPlan}
              onChange={(value) => {
        ...
        <Row style={{ marginTop: "20px" }}>
          <Col style={{ marginTop: "5px" }} span={Setting.isMobile() ? 22 : 2}>
            {Setting.getLabel(
              i18next.t("product:Payment providers"),
              i18next.t("product:Payment providers - Tooltip")
            )}{" "}
            :
          </Col>
          <Col span={22}>
            <Select
              ...
              style={{ width: "100%" }}
              disabled={isCreatedByPlan}
              value={this.state.product.providers}
              onChange={(value) => {
                this.updateProductField("providers", value);
              }}
            >
        ...
        <Row style={{ marginTop: "20px" }}>
          <Col style={{ marginTop: "5px" }} span={Setting.isMobile() ? 22 : 2}>
            {Setting.getLabel(
              i18next.t("product:Return URL"),
              i18next.t("product:Return URL - Tooltip")
            )}{" "}
            :
          </Col>
          <Col span={22}>
            <Input
              prefix={<LinkOutlined />}
              value={this.state.product.returnUrl}
              onChange={(e) => {
        ...
        <Row style={{ marginTop: "20px" }}>
          <Col style={{ marginTop: "5px" }} span={Setting.isMobile() ? 22 : 2}>
            {Setting.getLabel(
              i18next.t("product:Success URL"),
              i18next.t("product:Success URL - Tooltip")
            )}{" "}
            :
          </Col>
          <Col span={22}>
            <Input
              prefix={<LinkOutlined />}
              value={this.state.product.successUrl}
              onChange={(e) => {
        ...
        if (res.status === "ok") {
          ...
          if (exitAfterSave) {
            ...
            this.props.history.push(
              `/products/${this.state.product.owner}/${this.state.product.name}`
            );
          }
        } else {
          Setting.showMessage(
    ...
    return (
      <div>
        ...
        <div style={{ marginTop: "20px", marginLeft: "40px" }}>
          <Button size="large" onClick={() => this.submitProductEdit(false)}>
            {i18next.t("general:Save")}
          </Button>
          <Button
            style={{ marginLeft: "20px" }}
