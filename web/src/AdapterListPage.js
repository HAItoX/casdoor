      ...
      .then((res) => {
        if (res.status === "ok") {
          this.props.history.push({
            pathname: `/adapters/${newAdapter.owner}/${newAdapter.name}`,
            mode: "add",
          });
          Setting.showMessage(
            "success",
    ...
    const columns = [
      {
        ...
        render: (text, record, index) => {
          return <Link to={`/adapters/${record.owner}/${text}`}>{text}</Link>;
        },
      },
      {
      ...
      },
      {
        ...
        filters: [{ text: "Database", value: "Database" }],
      },
      {
          ...
          return (
            <div>
              <Button
                ...
                onClick={() =>
                  this.props.history.push(
                    `/adapters/${record.owner}/${record.name}`
                  )
                }
              >
          ...
          title={() => (
            <div>
              ...
              <Button
                type="primary"
                size="small"
                onClick={this.addAdapter.bind(this)}
              >
