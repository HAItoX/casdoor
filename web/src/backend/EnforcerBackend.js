...
export function getEnforcers(
  ...
  return fetch(
    `${Setting.ServerUrl}/api/get-enforcers?owner=${owner}&p=${page}&pageSize=${pageSize}&field=${field}&value=${value}&sortField=${sortField}&sortOrder=${sortOrder}`,
    {
      method: "GET",
      credentials: "include",
      headers: {
...
export function getEnforcer(owner, name, loadModelCfg = false) {
  return fetch(
    `${Setting.ServerUrl}/api/get-enforcer?id=${owner}/${encodeURIComponent(
      name
    )}&loadModelCfg=${loadModelCfg}`,
    {
      method: "GET",
      credentials: "include",
      headers: {
...
export function updateEnforcer(owner, name, enforcer) {
  ...
  return fetch(
    `${Setting.ServerUrl}/api/update-enforcer?id=${owner}/${encodeURIComponent(
      name
    )}`,
    {
      method: "POST",
