...
export function getSyncers(
  ...
  return fetch(
    `${Setting.ServerUrl}/api/get-syncers?owner=${owner}&organization=${organization}&p=${page}&pageSize=${pageSize}&field=${field}&value=${value}&sortField=${sortField}&sortOrder=${sortOrder}`,
    {
      method: "GET",
      credentials: "include",
      headers: {
...
export function getSyncer(owner, name) {
  return fetch(
    `${Setting.ServerUrl}/api/get-syncer?id=${owner}/${encodeURIComponent(
      name
    )}`,
    {
      method: "GET",
...
export function updateSyncer(owner, name, syncer) {
  ...
  return fetch(
    `${Setting.ServerUrl}/api/update-syncer?id=${owner}/${encodeURIComponent(
      name
    )}`,
    {
      method: "POST",
...
export function runSyncer(owner, name) {
  return fetch(
    `${Setting.ServerUrl}/api/run-syncer?id=${owner}/${encodeURIComponent(
      name
    )}`,
    {
      method: "GET",
