...
class SignupTable extends React.Component {
  ...
  addRow(table) {
    const row = {
      name: Setting.getNewRowNameForTable(table, "Please select a signup item"),
      visible: true,
      required: true,
      options: [],
      rule: "None",
    ...
    const columns = [
      {
        ...
        render: (text, record, index) => {
          const items = [
            ...
            {
              name: "Display name",
              displayName: i18next.t("general:Display name"),
            },
            ...
            {
              name: "Country/Region",
              displayName: i18next.t("user:Country/Region"),
            },
            { name: "ID card", displayName: i18next.t("user:ID card") },
            { name: "Password", displayName: i18next.t("general:Password") },
            {
              name: "Confirm password",
              displayName: i18next.t("signup:Confirm"),
            },
            { name: "Email", displayName: i18next.t("general:Email") },
            { name: "Phone", displayName: i18next.t("general:Phone") },
            {
              name: "Email or Phone",
              displayName: i18next.t("general:Email or Phone"),
            },
            {
              name: "Phone or Email",
              displayName: i18next.t("general:Phone or Email"),
            },
            {
              name: "Invitation code",
              displayName: i18next.t("application:Invitation code"),
            },
            { name: "Agreement", displayName: i18next.t("signup:Agreement") },
            {
              name: "Signup button",
              displayName: i18next.t("signup:Signup button"),
            },
            ...
            <Select
              ...
              onChange={(value) => {
                ...
                this.updateField(
                  ...
                  index,
                  "customCss",
                  SignupTableDefaultCssMap[value]
                );
              }}
            >
      ...
      },
      {
        ...
        render: (text, record, index) => {
          if (
            !record.visible ||
            ["Signup button", "Providers"].includes(record.name)
          ) {
            return null;
          }
      ...
      },
      {
        ...
        render: (text, record, index) => {
          const options = [
            ...
            {
              id: "Single Choice",
              name: i18next.t("application:Single Choice"),
            },
            {
              id: "Multiple Choices",
              name: i18next.t("application:Multiple Choices"),
            },
          ];
                  ...
                  <Editor
                    ...
                    onChange={(value) => {
                      this.updateField(
                        ...
                        index,
                        "customCss",
                        value ? value : SignupTableDefaultCssMap[record.name]
                      );
                    }}
                  />
                </div>
              ...
              <Input
                ...
                onChange={(e) => {
                  this.updateField(
                    ...
                    e.target.value
                      ? e.target.value
                      : SignupTableDefaultCssMap[record.name]
                  );
                }}
              />
            </Popover>
      ...
      },
      {
        ...
        render: (text, record, index) => {
          if (
            record.type !== "Single Choice" &&
            record.type !== "Multiple Choices"
          ) {
            return null;
          }
        ...
        render: (text, record, index) => {
          ...
          if (record.name === "ID") {
            ...
            options = [
              ...
              {
                id: "No verification",
                name: i18next.t("application:No verification"),
              },
            ];
            ...
            options = [
              ...
              {
                id: "Signin (Default True)",
                name: i18next.t("application:Signin (Default True)"),
              },
            ];
          ...
          return (
            <div>
              ...
              <Tooltip placement="topLeft" title={i18next.t("general:Delete")}>
                <Button
                  disabled={record.name === "Signup button"}
                  icon={<DeleteOutlined />}
                  size="small"
