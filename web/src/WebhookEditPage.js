...
const applicationTemplate = {
  ...
  logo: `${Setting.HitoXStaticBaseUrl}/logo/logo-site-dark.png`,
  enablePassword: true,
  enableSignUp: true,
  disableSignin: false,
...
class WebhookEditPage extends React.Component {
  ...
  getWebhook() {
    WebhookBackend.getWebhook("admin", this.state.webhookName).then((res) => {
      if (res.data === null) {
  ...
  renderWebhook() {
    ...
    if (this.state.webhook.isUserExtended) {
      if (
        this.state.webhook.tokenFields &&
        this.state.webhook.tokenFields.length !== 0
      ) {
        const extendedUser = {};
    ...
    return (
      <Card
        ...
        title={
          <div>
            {this.state.mode === "add"
              ? i18next.t("webhook:New Webhook")
              : i18next.t("webhook:Edit Webhook")}
            &nbsp;&nbsp;&nbsp;&nbsp;
            <Button onClick={() => this.submitWebhookEdit(false)}>
              {i18next.t("general:Save")}
            </Button>
            <Button
              style={{ marginLeft: "20px" }}
              type="primary"
              onClick={() => this.submitWebhookEdit(true)}
            >
      ...
      >
        <Row style={{ marginTop: "10px" }}>
          ...
          <Col span={22}>
            <Select
              ...
              value={this.state.webhook.organization}
              onChange={(value) => {
                this.updateWebhookField("organization", value);
              }}
            >
        ...
        <Row style={{ marginTop: "20px" }}>
          <Col style={{ marginTop: "5px" }} span={Setting.isMobile() ? 22 : 2}>
            {Setting.getLabel(
              ...
              i18next.t("webhook:Method - Tooltip")
            )}{" "}
            :
          </Col>
          <Col span={22}>
            <Select
              virtual={false}
              style={{ width: "100%" }}
              value={this.state.webhook.method}
              onChange={(value) => {
                this.updateWebhookField("method", value);
              }}
            >
              {[
                { id: "POST", name: "POST" },
        ...
        <Row style={{ marginTop: "20px" }}>
          <Col style={{ marginTop: "5px" }} span={Setting.isMobile() ? 22 : 2}>
            {Setting.getLabel(
              i18next.t("webhook:Content type"),
              i18next.t("webhook:Content type - Tooltip")
            )}{" "}
            :
          </Col>
          <Col span={22}>
            <Select
              ...
              onChange={(value) => {
                this.updateWebhookField("contentType", value);
              }}
            >
              {[
                ...
                <Option key={index} value={contentType.id}>
                  {contentType.name}
                </Option>
              ))}
            </Select>
        ...
        <Row style={{ marginTop: "20px" }}>
          <Col style={{ marginTop: "5px" }} span={Setting.isMobile() ? 22 : 2}>
            {Setting.getLabel(
              i18next.t("webhook:Headers"),
              i18next.t("webhook:Headers - Tooltip")
            )}{" "}
            :
          </Col>
          <Col span={22}>
            <WebhookHeaderTable
              ...
              onUpdateTable={(value) => {
                this.updateWebhookField("headers", value);
              }}
            />
          </Col>
        </Row>
        <Row style={{ marginTop: "20px" }}>
          <Col style={{ marginTop: "5px" }} span={Setting.isMobile() ? 22 : 2}>
            {Setting.getLabel(
              i18next.t("webhook:Events"),
              i18next.t("webhook:Events - Tooltip")
            )}{" "}
            :
          </Col>
          <Col span={22}>
            ...
            >
              {["signup", "login", "logout", "new-user"]
                .concat(this.getApiPaths())
                .map((option, index) => {
                  return (
        ...
        <Row style={{ marginTop: "20px" }}>
          <Col style={{ marginTop: "5px" }} span={Setting.isMobile() ? 22 : 2}>
            {Setting.getLabel(
              i18next.t("webhook:Object fields"),
              i18next.t("webhook:Object fields - Tooltip")
            )}{" "}
            :
          </Col>
          <Col span={22}>
            <Select
              ...
              showSearch
              style={{ width: "100%" }}
              value={this.state.webhook.objectFields}
              onChange={(value) => {
                this.updateWebhookField("objectFields", value);
              }}
            >
        ...
        <Row style={{ marginTop: "20px" }}>
          <Col style={{ marginTop: "5px" }} span={Setting.isMobile() ? 19 : 2}>
            {Setting.getLabel(
              i18next.t("webhook:Is user extended"),
              i18next.t("webhook:Is user extended - Tooltip")
            )}{" "}
            :
          </Col>
          <Col span={1}>
            <Switch
              checked={this.state.webhook.isUserExtended}
              onChange={(checked) => {
        ...
        <Row style={{ marginTop: "20px" }}>
          <Col style={{ marginTop: "5px" }} span={Setting.isMobile() ? 22 : 2}>
            {Setting.getLabel(
              i18next.t("webhook:Extended user fields"),
              i18next.t("webhook:Extended user fields - Tooltip")
            )}{" "}
            :
          </Col>
          <Col span={22}>
            <Select
              ...
              showSearch
              style={{ width: "100%" }}
              value={this.state.webhook.tokenFields}
              onChange={(value) => {
                this.updateWebhookField("tokenFields", value);
              }}
            >
        ...
        <Row style={{ marginTop: "20px" }}>
          <Col style={{ marginTop: "5px" }} span={Setting.isMobile() ? 22 : 2}>
            {Setting.getLabel(
              ...
              i18next.t("general:Preview - Tooltip")
            )}{" "}
            :
          </Col>
          <Col span={22}>
        ...
        <Row style={{ marginTop: "20px" }}>
          <Col style={{ marginTop: "5px" }} span={Setting.isMobile() ? 19 : 2}>
            {Setting.getLabel(
              i18next.t("webhook:Single org only"),
              i18next.t("webhook:Single org only - Tooltip")
            )}{" "}
            :
          </Col>
          <Col span={1}>
            <Switch
              checked={this.state.webhook.singleOrgOnly}
              onChange={(checked) => {
        ...
        <Row style={{ marginTop: "20px" }}>
          ...
          <Col span={1}>
            <Switch
              checked={this.state.webhook.isEnabled}
              onChange={(checked) => {
  ...
  submitWebhookEdit(exitAfterSave) {
    ...
    WebhookBackend.updateWebhook(
      this.state.webhook.owner,
      this.state.webhookName,
      webhook
    )
      .then((res) => {
        if (res.status === "ok") {
    ...
    return (
      <div>
        ...
        <div style={{ marginTop: "20px", marginLeft: "40px" }}>
          <Button size="large" onClick={() => this.submitWebhookEdit(false)}>
            {i18next.t("general:Save")}
          </Button>
          <Button
            style={{ marginLeft: "20px" }}
