    ...
    return (
      <Card
        ...
        title={
          <div>
            {this.state.mode === "add"
              ? i18next.t("pricing:New Pricing")
              : i18next.t("pricing:Edit Pricing")}
            &nbsp;&nbsp;&nbsp;&nbsp;
            <Button onClick={() => this.submitPricingEdit(false)}>
              {i18next.t("general:Save")}
            </Button>
            <Button
              style={{ marginLeft: "20px" }}
              type="primary"
              onClick={() => this.submitPricingEdit(true)}
            >
      ...
      >
        <Row style={{ marginTop: "10px" }}>
          ...
          <Col span={22}>
            <Select
              virtual={false}
              style={{ width: "100%" }}
              value={this.state.pricing.owner}
              onChange={(owner) => {
        ...
        <Row style={{ marginTop: "20px" }}>
          ...
          <Col span={22}>
            <Input
              value={this.state.pricing.displayName}
              onChange={(e) => {
        ...
        <Row style={{ marginTop: "20px" }}>
          ...
          <Col span={22}>
            <Input
              value={this.state.pricing.description}
              onChange={(e) => {
        ...
        <Row style={{ marginTop: "20px" }}>
          ...
          <Col span={22}>
            <Select
              virtual={false}
              style={{ width: "100%" }}
              value={this.state.pricing.application}
              onChange={(value) => {
                this.updatePricingField("application", value);
              }}
        ...
        <Row style={{ marginTop: "20px" }}>
          <Col style={{ marginTop: "5px" }} span={Setting.isMobile() ? 22 : 2}>
            {Setting.getLabel(
              ...
              i18next.t("general:Plans - Tooltip")
            )}{" "}
            :
          </Col>
          <Col span={22}>
            <Select
              ...
              mode="multiple"
              style={{ width: "100%" }}
              value={this.state.pricing.plans}
              onChange={(value) => {
        ...
        <Row style={{ marginTop: "20px" }}>
          <Col style={{ marginTop: "5px" }} span={Setting.isMobile() ? 22 : 2}>
            {Setting.getLabel(
              i18next.t("pricing:Trial duration"),
              i18next.t("pricing:Trial duration - Tooltip")
            )}{" "}
            :
          </Col>
          <Col span={22}>
            <InputNumber
              min={0}
              value={this.state.pricing.trialDuration}
              onChange={(value) => {
        ...
        <Row style={{ marginTop: "20px" }}>
          ...
          <Col span={1}>
            <Switch
              checked={this.state.pricing.isEnabled}
              onChange={(checked) => {
        ...
        if (res.status === "ok") {
          ...
          if (exitAfterSave) {
            ...
            this.props.history.push(
              `/pricings/${this.state.pricing.owner}/${this.state.pricing.name}`
            );
          }
        } else {
          Setting.showMessage(
    ...
    return (
      <div>
        ...
        <div style={{ marginTop: "20px", marginLeft: "40px" }}>
          <Button size="large" onClick={() => this.submitPricingEdit(false)}>
            {i18next.t("general:Save")}
          </Button>
          <Button
            style={{ marginLeft: "20px" }}
      ...
      <React.Fragment>
        <Col>
          <Button
            style={{
              marginBottom: "10px",
              marginTop: Setting.isMobile() ? "15px" : "0",
            }}
            type="primary"
            shape="round"
            icon={<CopyOutlined />}
        ...
        <Col>
          <PricingPage
            ...
            owner={this.state.pricing.owner}
          ></PricingPage>
        </Col>
      </React.Fragment>
    );
