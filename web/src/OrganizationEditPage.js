...
class OrganizationEditPage extends React.Component {
  ...
  getOrganization() {
    OrganizationBackend.getOrganization(
      "admin",
  ...
  getLdaps() {
    LdapBackend.getLdaps(this.state.organizationName).then((res) => {
      let resdata = [];
      if (res.status === "ok") {
        if (res.data !== null) {
          resdata = res.data;
  ...
  updatePasswordObfuscator(key, value) {
    ...
    if (key === "type") {
      ...
      organization.passwordObfuscatorKey =
        Obfuscator.getRandomKeyForObfuscator(value);
    } else if (key === "key") {
    ...
    return (
      <Card
        ...
        title={
          <div>
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;
            <Button onClick={() => this.submitOrganizationEdit(false)}>
              {i18next.t("general:Save")}
            </Button>
            <Button
              style={{ marginLeft: "20px" }}
              type="primary"
              onClick={() => this.submitOrganizationEdit(true)}
            >
      ...
      >
        <Row style={{ marginTop: "10px" }}>
          ...
          <Col span={22}>
            <Input
              ...
              disabled={this.state.organization.name === "built-in"}
              onChange={(e) => {
        ...
        <Row style={{ marginTop: "20px" }}>
          ...
          <Col span={22}>
            <Switch
              checked={this.state.organization.enableDarkLogo}
              onChange={(e) => {
        ...
        <Row style={{ marginTop: "20px" }}>
          <Col style={{ marginTop: "5px" }} span={Setting.isMobile() ? 22 : 2}>
            {Setting.getLabel(
              i18next.t("general:Logo"),
              i18next.t("general:Logo - Tooltip")
            )}{" "}
            :
          </Col>
          <Col span={22}>
            <Row style={{ marginTop: "20px" }}>
              <Col
                style={{ marginTop: "5px" }}
                span={Setting.isMobile() ? 22 : 1}
              >
                {Setting.getLabel(
                  i18next.t("general:URL"),
                  i18next.t("general:URL - Tooltip")
                )}{" "}
                :
              </Col>
              <Col span={23}>
            ...
            <Row style={{ marginTop: "20px" }}>
              ...
              <Col span={23}>
                <a
                  target="_blank"
                  rel="noreferrer"
                  href={this.state.organization.logo}
                >
                  <img
                    src={
                    ...
                    alt={this.state.organization.logo}
                    height={90}
        ...
        {!this.state.organization.enableDarkLogo ? null : (
          <Row style={{ marginTop: "20px" }}>
            ...
            >
              {Setting.getLabel(
                i18next.t("general:Logo dark"),
                i18next.t("general:Logo dark - Tooltip")
              )}{" "}
              :
            </Col>
            <Col span={22}>
              <Row style={{ marginTop: "20px" }}>
                ...
                <Col span={23}>
                  <Input
                    prefix={<LinkOutlined />}
                    value={this.state.organization.logoDark}
                    onChange={(e) => {
              ...
              <Row style={{ marginTop: "20px" }}>
                ...
                <Col span={23}>
                  <a
                    target="_blank"
                    rel="noreferrer"
                    href={this.state.organization.logoDark}
                  >
                    <img
                      src={
                        this.state.organization.logoDark
                          ? this.state.organization.logoDark
                          : Setting.getLogo(["dark"])
                      }
                      alt={this.state.organization.logoDark}
                      height={90}
        ...
        <Row style={{ marginTop: "20px" }}>
          <Col style={{ marginTop: "5px" }} span={Setting.isMobile() ? 22 : 2}>
            {Setting.getLabel(
              i18next.t("general:Favicon"),
              i18next.t("general:Favicon - Tooltip")
            )}{" "}
            :
          </Col>
          <Col span={22}>
            <Row style={{ marginTop: "20px" }}>
              ...
              <Col span={23}>
                <Input
                  prefix={<LinkOutlined />}
                  value={this.state.organization.favicon}
                  onChange={(e) => {
            ...
            <Row style={{ marginTop: "20px" }}>
              ...
              <Col span={23}>
                <a
                  target="_blank"
                  rel="noreferrer"
                  href={this.state.organization.favicon}
                >
                  <img
          ...
          <Row style={{ marginTop: "20px" }}>
            ...
            <Col span={1}>
              {!this.state.organization.hasPrivilegeConsent ? (
                <Popconfirm
                  title={i18next.t(
                    "organization:Has privilege consent warning"
                  )}
                  onConfirm={() => {
                ...
                >
                  <Switch
                    checked={this.state.organization.hasPrivilegeConsent}
                  />
                </Popconfirm>
              ) : (
                <Switch
        ...
        <Row style={{ marginTop: "20px" }}>
          ...
          <Col span={22}>
            <Select
              virtual={false}
              style={{ width: "100%" }}
              value={this.state.organization.passwordType}
              onChange={(value) => {
                this.updateOrganizationField("passwordType", value);
              }}
              options={[
                "plain",
                "salt",
        ...
        <Row style={{ marginTop: "20px" }}>
          ...
          <Col span={22}>
            <Input
              value={this.state.organization.passwordSalt}
              onChange={(e) => {
              ...
              options={[
                {
                  value: "AtLeast6",
                  name: i18next.t(
                    "user:The password must have at least 6 characters"
                  ),
                },
                {
                  value: "AtLeast8",
                  name: i18next.t(
                    "user:The password must have at least 8 characters"
                  ),
                },
                {
                  value: "Aa123",
        ...
        <Row style={{ marginTop: "20px" }}>
          ...
          <Col span={22}>
            <Select
              ...
              onChange={(value) => {
                this.updatePasswordObfuscator("type", value);
              }}
            >
              {[
                { id: "Plain", name: "Plain" },
                { id: "AES", name: "AES" },
                { id: "DES", name: "DES" },
              ].map((obfuscatorType, index) => (
                <Option key={index} value={obfuscatorType.id}>
                  {obfuscatorType.name}
                </Option>
              ))}
            </Select>
        ...
        {this.state.organization.passwordObfuscatorType === "Plain" ||
        this.state.organization.passwordObfuscatorType === "" ? null : (
          <Row style={{ marginTop: "20px" }}>
            <Col
              style={{ marginTop: "5px" }}
              span={Setting.isMobile() ? 22 : 2}
        ...
        <Row style={{ marginTop: "20px" }}>
          ...
          <Col span={4}>
            <InputNumber
              value={this.state.organization.passwordExpireDays}
              onChange={(value) => {
        ...
        <Row style={{ marginTop: "20px" }}>
          ...
          <Col span={22}>
            <Select
              ...
              mode={"multiple"}
              style={{ width: "100%" }}
              value={this.state.organization.countryCodes ?? []}
              onChange={(value) => {
            ...
            >
              {Setting.getCountryCodeOption({
                name: i18next.t("organization:All"),
                code: "All",
                phone: 0,
              })}
              {Setting.getCountryCodeData().map((country) =>
        ...
        <Row style={{ marginTop: "20px" }}>
          <Col style={{ marginTop: "5px" }} span={Setting.isMobile() ? 22 : 2}>
            {Setting.getLabel(
              ...
              i18next.t("general:Default avatar - Tooltip")
            )}{" "}
            :
          </Col>
          <Col span={22}>
            <Row style={{ marginTop: "20px" }}>
              ...
              <Col span={23}>
                <Input
                  prefix={<LinkOutlined />}
                  value={this.state.organization.defaultAvatar}
                  onChange={(e) => {
                    this.updateOrganizationField(
                      "defaultAvatar",
                      e.target.value
            ...
            <Row style={{ marginTop: "20px" }}>
              ...
              <Col span={23}>
                <a
                  target="_blank"
                  rel="noreferrer"
                  href={this.state.organization.defaultAvatar}
                >
                  <img
                    src={Setting.getLocalizedImageUrl(
        ...
        <Row style={{ marginTop: "20px" }}>
          ...
          <Col span={22}>
            <Select
              ...
              onChange={(value) => {
                this.updateOrganizationField("defaultApplication", value);
              }}
              options={this.state.applications?.map((item) =>
                Setting.getOption(
                  Setting.getApplicationDisplayName(item.name),
                  item.name
                )
              )}
            />
        ...
        <Row style={{ marginTop: "20px" }}>
          ...
          <Col span={22}>
            <Select
              ...
              mode="tags"
              style={{ width: "100%" }}
              value={this.state.organization.userTypes}
              onChange={(value) => {
                this.updateOrganizationField("userTypes", value);
              }}
            >
              {this.state.organization.userTypes?.map((item, index) => (
        ...
        <Row style={{ marginTop: "20px" }}>
          <Col style={{ marginTop: "5px" }} span={Setting.isMobile() ? 22 : 2}>
            {Setting.getLabel(
              ...
              i18next.t("organization:Tags - Tooltip")
            )}{" "}
            :
          </Col>
          <Col span={22}>
            <Select
              ...
              mode="tags"
              style={{ width: "100%" }}
              value={this.state.organization.tags}
              onChange={(value) => {
                this.updateOrganizationField("tags", value);
              }}
            >
              {this.state.organization.tags?.map((item, index) => (
                <Option key={index} value={item}>
                  {item}
                </Option>
              ))}
        ...
        <Row style={{ marginTop: "20px" }}>
          ...
          <Col span={22}>
            <Input
              value={this.state.organization.masterPassword}
              onChange={(e) => {
        ...
        <Row style={{ marginTop: "20px" }}>
          ...
          <Col span={22}>
            <Input
              value={this.state.organization.defaultPassword}
              onChange={(e) => {
        ...
        <Row style={{ marginTop: "20px" }}>
          ...
          <Col span={22}>
            <Input
              value={this.state.organization.masterVerificationCode}
              onChange={(e) => {
                this.updateOrganizationField(
        ...
        <Row style={{ marginTop: "20px" }}>
          ...
          <Col span={22}>
            <Input
              value={this.state.organization.ipWhitelist}
              onChange={(e) => {
        ...
        <Row style={{ marginTop: "20px" }}>
          ...
          <Col span={4}>
            <InputNumber
              value={this.state.organization.initScore}
              onChange={(value) => {
        ...
        <Row style={{ marginTop: "20px" }}>
          ...
          <Col span={1}>
            <Switch
              checked={this.state.organization.enableSoftDeletion}
              onChange={(checked) => {
        ...
        <Row style={{ marginTop: "20px" }}>
          ...
          <Col span={1}>
            <Switch
              checked={this.state.organization.isProfilePublic}
              onChange={(checked) => {
        ...
        <Row style={{ marginTop: "20px" }}>
          ...
          <Col span={1}>
            <Switch
              checked={this.state.organization.useEmailAsUsername}
              onChange={(checked) => {
        ...
        <Row style={{ marginTop: "20px" }}>
          ...
          <Col span={1}>
            <Switch
              checked={this.state.organization.enableTour}
              onChange={(checked) => {
        ...
        <Row style={{ marginTop: "20px" }}>
          ...
          <Col span={1}>
            <Switch
              checked={this.state.organization.disableSignin}
              onChange={(checked) => {
        ...
        <Row style={{ marginTop: "20px" }}>
          <Col style={{ marginTop: "5px" }} span={Setting.isMobile() ? 22 : 2}>
            {Setting.getLabel(
              i18next.t("organization:Navbar items"),
              i18next.t("organization:Navbar items - Tooltip")
            )}{" "}
            :
          </Col>
          <Col span={22}>
        ...
        <Row style={{ marginTop: "20px" }}>
          <Col style={{ marginTop: "5px" }} span={Setting.isMobile() ? 22 : 2}>
            {Setting.getLabel(
              i18next.t("organization:Account items"),
              i18next.t("organization:Account items - Tooltip")
            )}{" "}
            :
          </Col>
          <Col span={22}>
        ...
        <Row style={{ marginTop: "20px" }}>
          <Col style={{ marginTop: "5px" }} span={Setting.isMobile() ? 22 : 2}>
            {Setting.getLabel(
              i18next.t("application:MFA remember time"),
              i18next.t("application:MFA remember time - Tooltip")
            )}{" "}
            :
          </Col>
          <Col span={22}>
            <InputNumber
              style={{ width: "150px" }}
              value={this.state.organization.mfaRememberInHours}
              min={1}
              step={1}
              precision={0}
              addonAfter="Hours"
        ...
        <Row style={{ marginTop: "20px" }}>
          <Col style={{ marginTop: "5px" }} span={Setting.isMobile() ? 22 : 2}>
            {Setting.getLabel(
              i18next.t("general:MFA items"),
              i18next.t("general:MFA items - Tooltip")
            )}{" "}
            :
          </Col>
          <Col span={22}>
        ...
        <Row style={{ marginTop: "20px" }}>
          ...
          <Col span={22} style={{ marginTop: "5px" }}>
            <Row>
              <Radio.Group
                buttonStyle="solid"
                value={this.state.organization.themeData?.isEnabled ?? false}
                onChange={(e) => {
                  const { _, ...theme } = this.state.organization.themeData ?? {
                    ...Conf.ThemeDefault,
                    isEnabled: false,
                  };
                  this.updateOrganizationField("themeData", {
                    ...theme,
            ...
            {this.state.organization.themeData?.isEnabled ? (
              <Row style={{ marginTop: "20px" }}>
                <ThemeEditor
                  themeData={this.state.organization.themeData}
                  onThemeChange={(_, nextThemeData) => {
                    const { isEnabled } = this.state.organization.themeData ?? {
                      ...Conf.ThemeDefault,
                      isEnabled: false,
                    };
                    this.updateOrganizationField("themeData", {
        ...
        <Row style={{ marginTop: "20px" }}>
          <Col style={{ marginTop: "5px" }} span={Setting.isMobile() ? 22 : 2}>
            {Setting.getLabel(
              ...
              i18next.t("general:LDAPs - Tooltip")
            )}{" "}
            :
          </Col>
          <Col span={22}>
  ...
  submitOrganizationEdit(exitAfterSave) {
    ...
    organization.accountItems = organization.accountItems?.filter(
      (accountItem) => accountItem.name !== "Please select an account item"
    );

    const passwordObfuscatorErrorMessage = Obfuscator.checkPasswordObfuscator(
    ...
    OrganizationBackend.updateOrganization(
      this.state.organization.owner,
      this.state.organizationName,
      organization
    )
      .then((res) => {
        if (res.status === "ok") {
          ...
          if (
            this.props.account.organization.name === this.state.organizationName
          ) {
            this.props.onChangeTheme(
              Setting.getThemeData(this.state.organization)
            );
          }
          ...
          if (exitAfterSave) {
            ...
            this.props.history.push(
              `/organizations/${this.state.organization.name}`
            );
          }
        } else {
          Setting.showMessage(
    ...
    return (
      <div>
        ...
        <div style={{ marginTop: "20px", marginLeft: "40px" }}>
          <Button
            size="large"
            onClick={() => this.submitOrganizationEdit(false)}
          >
            {i18next.t("general:Save")}
          </Button>
          <Button
