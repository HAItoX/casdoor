      ...
      .then((res) => {
        if (res.status === "ok") {
          this.props.history.push({
            pathname: `/enforcers/${newEnforcer.owner}/${newEnforcer.name}`,
            mode: "add",
          });
          Setting.showMessage(
            "success",
    ...
    const columns = [
      {
        ...
        render: (text, record, index) => {
          return <Link to={`/enforcers/${record.owner}/${text}`}>{text}</Link>;
        },
      },
      {
      ...
      },
      {
        ...
        ...this.getColumnSearchProps("name"),
        render: (text, record, index) => {
          return <Link to={`/models/${text}`}>{text}</Link>;
        },
      },
      {
        ...
        ...this.getColumnSearchProps("name"),
        render: (text, record, index) => {
          return <Link to={`/adapters/${text}`}>{text}</Link>;
        },
      },
      {
          ...
          return (
            <div>
              <Button
                ...
                onClick={() =>
                  this.props.history.push(
                    `/enforcers/${record.owner}/${record.name}`
                  )
                }
              >
          ...
          title={() => (
            <div>
              ...
              <Button
                type="primary"
                size="small"
                onClick={this.addEnforcer.bind(this)}
              >
