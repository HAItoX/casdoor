            ...
            footerHtml && footerHtml !== "" ?
              ...
              : (
                Conf.CustomFooter !== null ? Conf.CustomFooter : (
                  <React.Fragment>
                  Powered by <a target="_blank" href="http://112.28.49.224:31126/" rel="noreferrer"><img style={{padding: "0 0 3px 5px"}} height={"40px"} alt={"HitoX"} src={logo} /></a>
                  </React.Fragment>
                )
              )
          }
          ...
          <React.Fragment>
            <Tooltip title="Want to deploy your own AI assistant? Click to learn more!">
              <a target="_blank" rel="noreferrer" href={"https://casdoor.com"}>
                <img style={{width: "20px", marginRight: "10px", marginBottom: "2px"}} alt="help" src="/img/casbin.svg" />
                AI Assistant
              </a>
            </Tooltip>
