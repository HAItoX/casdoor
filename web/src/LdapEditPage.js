...
class LdapEditPage extends React.Component {
  ...
  getLdap() {
    LddpBackend.getLdap(this.state.organizationName, this.state.ldapId).then(
      (res) => {
        if (res.status === "ok") {
          this.setState({
            ldap: res.data,
  ...
  renderAutoSyncWarn() {
    if (this.state.ldap.autoSync > 0) {
      return (
        ...
        >
          {i18next.t(
            "ldap:The Auto Sync option will sync all users to specify organization"
          )}
        </span>
      );
    }
    ...
    return (
      <Card
        ...
        title={
          <div>
            ...
            <Button onClick={() => this.submitLdapEdit()}>
              {i18next.t("general:Save")}
            </Button>
            <Button
              style={{ marginLeft: "20px" }}
              type="primary"
              onClick={() => this.submitLdapEdit(true)}
            >
            ...
            <Button
              ...
              onClick={() =>
                Setting.goToLink(
                  `/ldap/sync/${this.state.organizationName}/${this.state.ldapId}`
                )
              }
            >
      ...
      >
        ...
        <Row style={{ marginTop: "20px" }}>
          ...
          >
            {Setting.getLabel(
              ...
              i18next.t("ldap:Server name - Tooltip")
            )}{" "}
            :
          </Col>
          <Col span={21}>
            <Input
              value={this.state.ldap.serverName}
              onChange={(e) => {
        ...
        <Row style={{ marginTop: "20px" }}>
          ...
          >
            {Setting.getLabel(
              i18next.t("ldap:Server host"),
              i18next.t("ldap:Server host - Tooltip")
            )}{" "}
            :
          </Col>
          <Col span={21}>
            <Input
              value={this.state.ldap.host}
              onChange={(e) => {
        ...
        <Row style={{ marginTop: "20px" }}>
          ...
          >
            {Setting.getLabel(
              i18next.t("ldap:Server port"),
              i18next.t("ldap:Server port - Tooltip")
            )}{" "}
            :
          </Col>
          <Col span={21}>
        ...
        <Row style={{ marginTop: "20px" }}>
          ...
          >
            {Setting.getLabel(
              i18next.t("ldap:Enable SSL"),
              i18next.t("ldap:Enable SSL - Tooltip")
            )}{" "}
            :
          </Col>
          <Col span={21}>
            <Switch
              checked={this.state.ldap.enableSsl}
              onChange={(checked) => {
        ...
        <Row style={{ marginTop: "20px" }}>
          ...
          >
            {Setting.getLabel(
              i18next.t("ldap:Allow self-signed certificate"),
              i18next.t("ldap:Allow self-signed certificate - Tooltip")
            )}{" "}
            :
          </Col>
          <Col span={21}>
            <Switch
              checked={this.state.ldap.allowSelfSignedCert}
              onChange={(checked) => {
        ...
        <Row style={{ marginTop: "20px" }}>
          ...
          >
            {Setting.getLabel(
              i18next.t("ldap:Base DN"),
              i18next.t("ldap:Base DN - Tooltip")
            )}{" "}
            :
          </Col>
          <Col span={21}>
            <Input
              value={this.state.ldap.baseDn}
              onChange={(e) => {
        ...
        <Row style={{ marginTop: "20px" }}>
          ...
          >
            {Setting.getLabel(
              i18next.t("ldap:Search Filter"),
              i18next.t("ldap:Search Filter - Tooltip")
            )}{" "}
            :
          </Col>
          <Col span={21}>
            <Input
              value={this.state.ldap.filter}
              onChange={(e) => {
        ...
        <Row style={{ marginTop: "20px" }}>
          ...
          >
            {Setting.getLabel(
              i18next.t("ldap:Filter fields"),
              i18next.t("ldap:Filter fields - Tooltip")
            )}{" "}
            :
          </Col>
          <Col span={21}>
            <Select
              value={this.state.ldap.filterFields ?? []}
              style={{ width: "100%" }}
              mode={"multiple"}
              options={[
                { value: "uid", label: "uid" },
        ...
        <Row style={{ marginTop: "20px" }}>
          ...
          >
            {Setting.getLabel(
              i18next.t("ldap:Admin"),
              i18next.t("ldap:Admin - Tooltip")
            )}{" "}
            :
          </Col>
          <Col span={21}>
            <Input
              value={this.state.ldap.username}
              onChange={(e) => {
        ...
        <Row style={{ marginTop: "20px" }}>
          ...
          >
            {Setting.getLabel(
              i18next.t("ldap:Admin Password"),
              i18next.t("ldap:Admin Password - Tooltip")
            )}{" "}
            :
          </Col>
          <Col span={21}>
        ...
        <Row style={{ marginTop: "20px" }}>
          ...
          <Col span={21}>
            <Select
              virtual={false}
              style={{ width: "100%" }}
              value={this.state.ldap.passwordType ?? []}
              onChange={(value) => {
                this.updateLdapField("passwordType", value);
              }}
            >
              <Option key={"Plain"} value={"Plain"}>
                {i18next.t("general:Plain")}
              </Option>
              <Option key={"SSHA"} value={"SSHA"}>
                SSHA
              </Option>
        ...
        <Row style={{ marginTop: "20px" }}>
          ...
          >
            {Setting.getLabel(
              i18next.t("ldap:Default group"),
              i18next.t("ldap:Default group - Tooltip")
            )}{" "}
            :
          </Col>
          <Col span={21}>
            ...
            >
              <Option key={""} value={""}>
                <Space>{i18next.t("general:Default")}</Space>
              </Option>
        ...
        <Row style={{ marginTop: "20px" }}>
          ...
          >
            {Setting.getLabel(
              i18next.t("ldap:Auto Sync"),
              i18next.t("ldap:Auto Sync - Tooltip")
            )}{" "}
            :
          </Col>
          <Col span={21}>
            <InputNumber
              ...
              formatter={(value) => value.replace(/\$\s?|(,*)/g, "")}
              disabled={false}
              value={this.state.ldap.autoSync}
              onChange={(value) => {
    ...
    return (
      <div>
        ...
        <div style={{ marginTop: "20px", marginLeft: "40px" }}>
          <Button size="large" onClick={() => this.submitLdapEdit()}>
            {i18next.t("general:Save")}
          </Button>
          <Button
            style={{ marginLeft: "20px" }}
